...
import helpIcon from "../../../public/pub-hyper/assets/images/help-icon.svg";

export function LeftSideMenuView() {
  return (
    <div className="leftside-menu">
      {/* LOGO */}
      <a href="index.html" className="logo text-center logo-light">
        <span className="logo-lg">
          <Image src={Logo} height={48} alt="Coint" priority style={{ width: "auto" }} />
        </span>
      ...
      <div className="h-100" id="leftside-menu-container" data-simplebar="">
        <ul className="side-nav">
          ...
          <li className="side-nav-item">
            <a
              ...
              href="src/view/layout/layout#sidebarDashboards"
              aria-expanded="false"
          ...
          <li className="side-nav-item">
            <a
              data-bs-toggle="collapse"
              href="src/view/layout/layout#sidebarEcommerce"
              aria-expanded="false"
          ...
          <li className="side-nav-item">
            <a
              data-bs-toggle="collapse"
              href="src/view/layout/layout#sidebarEmail"
              aria-expanded="false"
          ...
          <li className="side-nav-item">
            <a
              data-bs-toggle="collapse"
              href="src/view/layout/layout#sidebarProjects"
              aria-expanded="false"
          ...
          <li className="side-nav-item">
            <a
              data-bs-toggle="collapse"
              href="src/view/layout/layout#sidebarTasks"
              aria-expanded="false"
          ...
          <li className="side-nav-item">
            <a
              data-bs-toggle="collapse"
              href="src/view/layout/layout#sidebarPages"
              aria-expanded="false"
            ...
            <div className="collapse" id="sidebarPages">
              <ul className="side-nav-second-level">
                ...
                <li className="side-nav-item">
                  <a
                    data-bs-toggle="collapse"
                    href="src/view/layout/layout#sidebarPagesAuth"
                    aria-expanded="false"
                ...
                <li className="side-nav-item">
                  <a
                    data-bs-toggle="collapse"
                    href="src/view/layout/layout#sidebarPagesError"
                    aria-expanded="false"
          ...
          <li className="side-nav-item">
            <a
              data-bs-toggle="collapse"
              href="src/view/layout/layout#sidebarLayouts"
              aria-expanded="false"
          ...
          <li className="side-nav-item">
            <a
              data-bs-toggle="collapse"
              href="src/view/layout/layout#sidebarBaseUI"
              aria-expanded="false"
          ...
          <li className="side-nav-item">
            <a
              data-bs-toggle="collapse"
              href="src/view/layout/layout#sidebarExtendedUI"
              aria-expanded="false"
          ...
          <li className="side-nav-item">
            <a
              data-bs-toggle="collapse"
              href="src/view/layout/layout#sidebarIcons"
              aria-expanded="false"
          ...
          <li className="side-nav-item">
            <a
              data-bs-toggle="collapse"
              href="src/view/layout/layout#sidebarForms"
              aria-expanded="false"
          ...
          <li className="side-nav-item">
            <a
              data-bs-toggle="collapse"
              href="src/view/layout/layout#sidebarCharts"
              aria-expanded="false"
            ...
            <div className="collapse" id="sidebarCharts">
              <ul className="side-nav-second-level">
                <li className="side-nav-item">
                  <a
                    data-bs-toggle="collapse"
                    href="src/view/layout/layout#sidebarApexCharts"
                    aria-expanded="false"
          ...
          <li className="side-nav-item">
            <a
              data-bs-toggle="collapse"
              href="src/view/layout/layout#sidebarTables"
              aria-expanded="false"
          ...
          <li className="side-nav-item">
            <a
              data-bs-toggle="collapse"
              href="src/view/layout/layout#sidebarMaps"
              aria-expanded="false"
          ...
          <li className="side-nav-item">
            <a
              data-bs-toggle="collapse"
              href="src/view/layout/layout#sidebarMultiLevel"
              aria-expanded="false"
            ...
            <div className="collapse" id="sidebarMultiLevel">
              <ul className="side-nav-second-level">
                <li className="side-nav-item">
                  <a
                    data-bs-toggle="collapse"
                    href="src/view/layout/layout#sidebarSecondLevel"
                    aria-expanded="false"
                  ...
                  <div className="collapse" id="sidebarSecondLevel">
                    <ul className="side-nav-third-level">
                      <li>
                        <a href="src/view/layout/layout#">Item 1</a>
                      </li>
                      <li>
                        <a href="src/view/layout/layout#">Item 2</a>
                      </li>
                    </ul>
                  </div>
                </li>
                <li className="side-nav-item">
                  <a
                    data-bs-toggle="collapse"
                    href="src/view/layout/layout#sidebarThirdLevel"
                    aria-expanded="false"
                  ...
                  <div className="collapse" id="sidebarThirdLevel">
                    <ul className="side-nav-third-level">
                      ...
                      <li className="side-nav-item">
                        <a
                          data-bs-toggle="collapse"
                          href="src/view/layout/layout#sidebarFourthLevel"
                          aria-expanded="false"
                        ...
                        <div className="collapse" id="sidebarFourthLevel">
                          <ul className="side-nav-forth-level">
                            <li>
                              <a href="src/view/layout/layout#">Item 2.1</a>
                            </li>
                            <li>
                              <a href="src/view/layout/layout#">Item 2.2</a>
                            </li>
                          </ul>
                        </div>
                      </li>
        ...
        <div className="help-box text-white text-center">
          <a href="src/view/layout/layout#" className="float-end close-btn text-white">
            <i className="mdi mdi-close" />
          </a>
          <Image src={helpIcon} height={90} alt="Helper Icon Image" />
          <h5 className="mt-3">Unlimited Access</h5>
          <p className="mb-3">Upgrade to plan to get access to unlimited reports</p>
          <a href="src/view/layout/layout#" className="btn btn-outline-light btn-sm">
            Upgrade
          </a>
        </div>
        {/* end Help Box */}
